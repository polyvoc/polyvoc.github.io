...
function changeToCourse4() {
    ...
    document.getElementById("courses-main-text").innerHTML = 
    "Students prepare for their college art portfolio, building on learned skills and foundations. Price varies based on individual needs and packages.<br><br>Class Size: 4 - 6 students";
}
